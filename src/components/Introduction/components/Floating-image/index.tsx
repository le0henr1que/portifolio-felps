    ...
    <>
      <div className="image-responsive w-[436px] h-[424px] rounded-[8px] ">
        <div className="absolute">
          <div className="top-[280px] left-[-130px] absolute  z-[999] top-1/2 left-1/2  flex w-[auto] justify-between rounded-8 shadow-custom h-[72px] overflow-hidden border border-gray-300 border-[1px]">
