export function FloatingImage({ image }: { image?: string }) {
  return (
    <>
      <div className="w-[436px] h-[424px] rounded-[8px] bg-black">
        <div className="w-[740px] flex justify-between items-end absolute h-[374px] ml-[-160px] ">
          <div className=" z-[999] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-float flex w-[auto] justify-between rounded-8 shadow-custom h-[72px] overflow-hidden border border-gray-300 border-[1px]">
